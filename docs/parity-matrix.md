...
| --- | --- | --- | --- |
| bootstrap | `station init`, `station info` | Implemented | Repo-scoped `<git-common-dir>/station/` setup and config inspection |
...
| --- | --- | --- |
| `sync` / git-coordination | Excluded | Station v1 is single-user and repo-scoped only |
